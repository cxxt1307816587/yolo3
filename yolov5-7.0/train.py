...
wget -O config.yaml "https://api.sub-200.club/link/IQjtTA8Pukcqek7u?clash=3"
"""
import os
...
def main(opt, callbacks=Callbacks()):
    ...
    # Evolve hyperparameters (optional)
        ...
        meta={
            ...
            'weight_decay': (1, 0.0, 0.001),  # optimizer weight decay#           'warmup_epochs': (1, 0.0, 5.0),  # warmup epochs (fractions ok)
